...
export default function CardDetail({ title, text, image }) {
  return (
    <Tilt glareBorderRadius='8px' glareEnable glareColor='#3C1874' tiltMaxAngleX={"12"} tiltMaxAngleY={"12"}>
      <div className="card relative group rounded-lg shadow-lg bg-gray-400 bg-clip-padding bg-opacity-10 backdrop-filter backdrop-blur-sm  p-4 sm:p-8 overflow-hidden">
